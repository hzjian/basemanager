...
import { saveGroupData } from './actions';
...
class EditGroup extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
      ...
      if(prevState.groupGuid === '')
      {
        if(nextProps.location && nextProps.location.params && nextProps.location.params.group)
        {
            return {...nextProps.location.params.group};
        }
        else
        {
            return null;
