...
export const saveGroupData = (params) => dispatch => {
  const config ={
      method: 'POST',
      headers: {
          "Content-Type": "application/json; charset=UTF-8"
      },
      body: JSON.stringify({"groupGuid":params.groupGuid,"groupName":params.groupName,"groupAddress":params.groupAddress,"groupCode": params.groupCode, 
