...
import { saveGroupMember } from './actions';
...
class EditMember extends Component {
  ...
  saveMemberClick = () => {
    ...
    {
      this.props.saveGroupMember( this.state ).then(()=>{
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    {
      if(nextProps.location && nextProps.location.params && nextProps.location.params.member)
      {
          return {...nextProps.location.params.member};
      }
      else
      {
          return null;
      ...
      <div>
        <Paper className={classes.root}>
              <List>
                  ...
                  <ListItem>
                      <Typography>
                          <Button variant="contained" size="large" color="primary" className={classes.button} onClick= {this.saveMemberClick.bind(this)}>
                              保存
                          </Button>
...
export default connect(mapStateToProps,mapDispatchToProps)(withStyles(styles)(EditMember));